...
compensationFactor = (1.25, 2., .83, 2.9, 2.03, .83, 2.73, .8) # (0.74, 0.79, 0.68, 0.77, 0.88, 0.96, 0.70, 0.79) #(1., 1., 1., 1., 1., 1., 1., 1.)#(1.13, 1.58, 1.33, 1.21, 1.31, 2.25, 1.14, 1.24)
...
TimeToReachReward=4 #4 #6#220#220 #10 #Time that the animal has to get the reward
